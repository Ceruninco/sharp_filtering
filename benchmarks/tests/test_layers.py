...
from opacus_local.grad_sample.gsm_exp_weights import GradSampleModuleExpandedWeights
from opacus_local.layers import DPGRU, DPLSTM, DPRNN, DPMultiheadAttention
...
def test_layer_outputs(
    ...
    torch.nn.Module or opacus_local.layers.DPModule) should produce the same output
