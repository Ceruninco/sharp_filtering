...
# Precomputed characteristics of the FashionMNIST dataset
FASHION_MNIST_MEAN = 0.2860
FASHION_MNIST_STD = 0.3530
torch.set_default_dtype(torch.float64)


# --------- ResNet-8 with GroupNorm for FashionMNIST --------- #
...
class ResNet8GN(nn.Module):
    ...
    def __init__(self, num_classes=10, num_groups=8):
        ...
        # FashionMNIST: single-channel input
        self.conv1 = nn.Conv2d(
...
def main():
            ...
            transform=transforms.Compose(
                [
                    ...
                    transforms.Normalize(
                        (FASHION_MNIST_MEAN,), (FASHION_MNIST_STD,)
                    ),
                ]
            ),
        ),
    ...
    csv_filename = "training_metrics_fashionmnist_noise_2411.csv"
