...
Example:
    ...
    $ python -m opacus_local.scripts.compute_dp_sgd_privacy --epochs=3 --delta=1e-5 --sample-rate 0.01 --noise-multiplier 1.0 --alphas 2 5 10 20 100
...
from opacus_local.accountants.analysis.rdp import compute_rdp, get_privacy_spent
