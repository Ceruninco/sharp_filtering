...
from opacus_local.grad_sample import wrap_model
from opacus_local.utils.module_utils import trainable_parameters
from opacus_local.utils.packed_sequences import compute_seq_lengths
...
def check_per_sample_gradients_are_correct(
    ...
    *,
    ...
    with the result of optimized opacus_local method.
    ...
    Example:
        ...
        ...            x,
        ...            model
        ...        ) # This will fail only if the opacus_local per sample gradients do not match the micro-batch gradients.
    """
    reductions = ["sum", "mean"]
