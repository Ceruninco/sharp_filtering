...
import torch
from opacus_local.optimizers.utils import params
...
def _check_processed_flag_tensor(x: torch.Tensor):
    ...
    See Also:
        :meth:`~opacus_local.optimizers.optimizer._mark_as_processed`
...
class DPOptimizer(Optimizer):
    ...
    def signal_skip_step(self, do_skip=True):
        ...
        Used by :class:`~opacus_local.utils.batch_memory_manager.BatchMemoryManager` to
    ...
    def zero_grad(self, set_to_none: bool = False):
        ...
        if set_to_none is False:
            logger.debug(
                ...
                "opacus_local will set p.grad_sample and p.summed_grad to None due to "
