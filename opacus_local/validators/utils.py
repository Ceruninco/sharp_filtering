...
def register_module_validator(
    ...
    ... def validate(module: nn.Module, **kwargs) -> List[opacus_local.validators.errors.UnsupportedError]:
    ...    pass

    It may help you to take a look at the existing validator inside Opacus, under ``opacus_local.validators.``
    """
...
def register_module_fixer(
    ...
    It may help you to take a look at the existing fixers inside Opacus, under ``opacus_local.validators.``
    """
